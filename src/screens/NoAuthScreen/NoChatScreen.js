...
import { nochatImg, notificationImg, notifyImg } from '../../utils/Images'
import { withTranslation, useTranslation } from 'react-i18next';

const NoChatScreen = ({ navigation }) => {
    const { t, i18n } = useTranslation();
    return (
        <SafeAreaView style={styles.Container}>
            <ScrollView style={styles.wrapper}>
                <View style={{justifyContent:'center',alignItems:'center',marginTop: responsiveHeight(15)}}>
                    <Image source={nochatImg} style={styles.iconImage}/>
...
export default withTranslation()(NoChatScreen)
