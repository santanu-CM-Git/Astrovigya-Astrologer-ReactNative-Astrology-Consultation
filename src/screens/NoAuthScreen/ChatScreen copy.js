...
const ChatScreen = ({ route }) => {
  ...
  useEffect(() => {
    console.log(route?.params?.details, 'kkkkkkkkkk')
  }, [])
  ...
  useEffect(() => {
    ...
    setBirthDetailsText(messageText)
...
const styles = StyleSheet.create({
  ...
  audioSectionTherapistName: { color: '#FFF', fontSize: responsiveFontSize(2.6), fontFamily: 'PlusJakartaSans-Bold', marginTop: responsiveHeight(2), marginBottom: responsiveHeight(2) },
