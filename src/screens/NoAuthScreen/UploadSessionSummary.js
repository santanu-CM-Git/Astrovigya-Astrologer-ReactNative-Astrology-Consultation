    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ paddingHorizontal: 20, paddingVertical: 10, marginTop: responsiveHeight(5) }}>
                ...
                <Text style={{ fontFamily: 'PlusJakartaSans-Regular', fontSize: responsiveFontSize(1.7), color: '#746868', marginBottom: responsiveHeight(1), }}>Write session summary to proceed</Text>
            </View>
