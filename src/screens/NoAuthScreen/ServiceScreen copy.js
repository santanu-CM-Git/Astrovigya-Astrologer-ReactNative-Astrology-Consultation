...
const ServiceScreen = ({ navigation }) => {
        ...
        AsyncStorage.getItem('userToken', (err, usertoken) => {
            axios.get(`${API_URL}/astrologer/astrologer-service`, {
                ...
                .then(res => {
                    ...
                    setRate(JSON.stringify(res?.data?.astrology?.rate_price))
    ...
    return (
        <SafeAreaView style={styles.Container}>
            <CustomHeader commingFrom={'My Services'} onPress={() => navigation.goBack()} title={'My Services'} />
            <ScrollView style={styles.wrapper}>
                <View style={{ marginBottom: responsiveHeight(0) }}>
                    <Text style={styles.headerText}>Online Consultation</Text>
                </View>
                ...
                <View style={{ marginBottom: responsiveHeight(0) }}>
                    <Text style={styles.headerText}>Call/Chat Rate ( Rupees/Min)<Text style={{ color: 'red' }}> *</Text></Text>
                </View>
                ...
                {services.map((service, index) => (
                    <View key={index} style={{ marginBottom: responsiveHeight(2) }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text style={styles.header}>Remedies</Text>
                        ...
                        <View style={{ marginBottom: responsiveHeight(0) }}>
                            <Text style={styles.headerText}>
                                Remedies Rate (min amount {service.remediesminrate})<Text style={{ color: 'red' }}> *</Text>
                            </Text>
                        </View>
                        <View style={styles.textinputview}>
                            <InputField
                ...
                <View style={styles.termsView}>
                    ...
                    <Text style={styles.termsText}>50% will be deducted as platform fee</Text>
                </View>
            ...
            <TouchableOpacity style={styles.addButton} onPress={addService}>
                <View style={styles.inActiveButtonInsideView}>
                    ...
                    />
                    <Text style={styles.activeButtonInsideText}>Add New Service</Text>
                </View>
            </TouchableOpacity>
